...
export const AlertAppearances: IAlertAppearance[] = ["default", "information", "success", "warning", "danger"];
    ...
    if (this.state.visible) {
      return (
        ...
        >
          ...
          {this.props.dismissible && <Cross onClick={this.dismiss} {...Automation("alert.dismiss")} />}
        </Alert.Element>
      );
    } else {
      return null;
